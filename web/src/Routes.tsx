...
const Routes = () => {
  return (
    <Router useAuth={useAuth}>
      <Set wrap={ScaffoldLayout} title="StudySets" titleTo="studySets" buttonLabel="New StudySet" buttonTo="newStudySet">
      ...
      <Set wrap={ScaffoldLayout} title="StudySetDecks" titleTo="studySetDecks" buttonLabel="New StudySetDeck" buttonTo="newStudySetDeck">
      ...
      <Set wrap={ScaffoldLayout} title="Flashcards" titleTo="flashcards" buttonLabel="New Flashcard" buttonTo="newFlashcard">
      ...
      <Set wrap={ScaffoldLayout} title="Decks" titleTo="decks" buttonLabel="New Deck" buttonTo="newDeck">
